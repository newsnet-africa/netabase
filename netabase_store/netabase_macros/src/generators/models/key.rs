...
impl<'ast> NetabaseModelVisitor<'ast> {
    pub fn generate_key(&self) -> (ItemEnum, ItemEnum, ItemStruct, ItemEnum) {
        ...
        let mut primary_key_derive = quote::quote!(
            ::netabase_store::__macro_deps::__private::bincode::Encode,
            ::netabase_store::__macro_deps::__private::bincode::Decode,
            Debug,
            Clone,
            PartialEq,
            Eq,
            Hash,
            ::netabase_store::__macro_deps::__private::derive_more::From,
            ::netabase_store::__macro_deps::__private::derive_more::Into,
            ::netabase_store::__macro_deps::__private::serde::Serialize,
            ::netabase_store::__macro_deps::__private::serde::Deserialize
        );
        ...
        let secondary_keys_enum: ItemEnum = if secondary_key_variants.is_empty() {
            ...
            parse_quote! {
                #[derive(::netabase_store::__macro_deps::__private::bincode::Encode, ::netabase_store::__macro_deps::__private::bincode::Decode, Debug, Clone, Hash, PartialEq, Eq, ::netabase_store::__macro_deps::__private::serde::Serialize, ::netabase_store::__macro_deps::__private::serde::Deserialize)]
            ...
            parse_quote! {
                #[derive(::netabase_store::__macro_deps::__private::bincode::Encode, ::netabase_store::__macro_deps::__private::bincode::Decode, Debug, Clone, Hash, PartialEq, Eq, ::netabase_store::__macro_deps::__private::strum::EnumIter, ::netabase_store::__macro_deps::__private::strum::EnumDiscriminants, ::netabase_store::__macro_deps::__private::serde::Serialize, ::netabase_store::__macro_deps::__private::serde::Deserialize)]
                #[strum_discriminants(derive(::netabase_store::__macro_deps::__private::strum::EnumIter, ::netabase_store::__macro_deps::__private::strum::AsRefStr, Hash))]
                pub enum #secondary_keys_name {
        ...
        let main_key_enum: ItemEnum = parse_quote! {
            #[derive(::netabase_store::__macro_deps::__private::bincode::Encode, ::netabase_store::__macro_deps::__private::bincode::Decode, Debug, Clone, PartialEq, Eq, Hash, ::netabase_store::__macro_deps::__private::derive_more::From, ::netabase_store::__macro_deps::__private::derive_more::TryInto, ::netabase_store::__macro_deps::__private::serde::Serialize, ::netabase_store::__macro_deps::__private::serde::Deserialize)]
            pub enum #key_name {
        ...
        parse_quote! {
            impl #trait_path for #key_name {
                ...
                fn secondary_key_discriminants() -> Vec<Self::SecondaryKeysDiscriminants> {
                    <Self::SecondaryKeysDiscriminants as ::netabase_store::__macro_deps::__private::strum::IntoEnumIterator>::iter().collect()
                }
    ...
    pub fn generate_secondary_keys_try_from_ivec_impl(&self) -> syn::ItemImpl {
        ...
        parse_quote! {
            impl TryFrom<::netabase_store::__macro_deps::__private::sled::IVec> for #secondary_keys_name {
                type Error = #error_path;
                fn try_from(ivec: ::netabase_store::__macro_deps::__private::sled::IVec) -> Result<Self, Self::Error> {
                    Ok(::netabase_store::__macro_deps::__private::bincode::decode_from_slice::<Self, _>(&ivec, ::netabase_store::__macro_deps::__private::bincode::config::standard())?.0)
                }
            }
        }
    }
    ...
    pub fn generate_secondary_keys_try_into_ivec_impl(&self) -> syn::ItemImpl {
        ...
        let error_path = netabase_error_type_path();
        parse_quote! {
            impl TryFrom<#secondary_keys_name> for ::netabase_store::__macro_deps::__private::sled::IVec {
                type Error = #error_path;
                fn try_from(value: #secondary_keys_name) -> Result<Self, Self::Error> {
                    Ok(::netabase_store::__macro_deps::__private::sled::IVec::from(::netabase_store::__macro_deps::__private::bincode::encode_to_vec(&value, ::netabase_store::__macro_deps::__private::bincode::config::standard())?))
                }
            }
        }
    }
    ...
    pub fn generate_relations_try_from_ivec_impl(&self) -> syn::ItemImpl {
        ...
        let error_path = netabase_error_type_path();
        parse_quote! {
            impl TryFrom<::netabase_store::__macro_deps::__private::sled::IVec> for #relations_name {
                type Error = #error_path;
                fn try_from(ivec: ::netabase_store::__macro_deps::__private::sled::IVec) -> Result<Self, Self::Error> {
                    Ok(::netabase_store::__macro_deps::__private::bincode::decode_from_slice::<Self, _>(&ivec, ::netabase_store::__macro_deps::__private::bincode::config::standard())?.0)
                }
    ...
    pub fn generate_relations_try_into_ivec_impl(&self) -> syn::ItemImpl {
        ...
        let error_path = netabase_error_type_path();
        parse_quote! {
            impl TryFrom<#relations_name> for ::netabase_store::__macro_deps::__private::sled::IVec {
                type Error = #error_path;
    ...
    pub fn generate_secondary_keys_placeholder_impls(&self) -> proc_macro2::TokenStream {
        ...
        if self.secondary_key_fields.is_empty() {
            ...
            quote::quote! {
                impl ::netabase_store::__macro_deps::__private::strum::IntoEnumIterator for #secondary_keys_name {
                    type Iterator = ::netabase_store::__macro_deps::__private::std::iter::Once<Self>;
                    fn iter() -> Self::Iterator {
                        ::netabase_store::__macro_deps::__private::std::iter::once(#secondary_keys_name::_NoSecondaryKeys)
                    }
                }
    ...
    pub fn generate_relations_placeholder_impls(&self) -> proc_macro2::TokenStream {
        ...
        quote::quote! {
            impl ::netabase_store::__macro_deps::__private::strum::IntoEnumIterator for #relations_name {
                type Iterator = ::netabase_store::__macro_deps::__private::std::iter::Once<Self>;
                fn iter() -> Self::Iterator {
                    ::netabase_store::__macro_deps::__private::std::iter::once(#relations_name::_NoRelations)
                }
            }
    ...
    pub fn generate_main_key_ivec_impls(&self) -> proc_macro2::TokenStream {
        ...
        quote::quote! {
            impl TryFrom<::netabase_store::__macro_deps::__private::sled::IVec> for #key_name {
                type Error = #error_path;
                fn try_from(ivec: ::netabase_store::__macro_deps::__private::sled::IVec) -> Result<Self, Self::Error> {
                    Ok(::netabase_store::__macro_deps::__private::bincode::decode_from_slice::<Self, _>(&ivec, ::netabase_store::__macro_deps::__private::bincode::config::standard())?.0)
                }
            ...
            impl TryFrom<#key_name> for ::netabase_store::__macro_deps::__private::sled::IVec {
                type Error = #error_path;
    ...
    pub fn generate_model_ivec_impls(&self) -> proc_macro2::TokenStream {
        ...
        quote::quote! {
            impl TryFrom<::netabase_store::__macro_deps::__private::sled::IVec> for #name {
                type Error = #error_path;
                fn try_from(ivec: ::netabase_store::__macro_deps::__private::sled::IVec) -> Result<Self, Self::Error> {
                    Ok(::netabase_store::__macro_deps::__private::bincode::decode_from_slice::<Self, _>(&ivec, ::netabase_store::__macro_deps::__private::bincode::config::standard())?.0)
                }
            ...
            impl TryFrom<#name> for ::netabase_store::__macro_deps::__private::sled::IVec {
                type Error = #error_path;
