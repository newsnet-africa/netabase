...
pub fn generate_module_schema(
    ...
    let key_enum = parse_quote! {
        #[derive(::netabase_store::__macro_deps::__private::derive_more::From, ::netabase_store::__macro_deps::__private::derive_more::TryInto, Clone, Debug, ::netabase_store::__macro_deps::__private::bincode::Encode, ::netabase_store::__macro_deps::__private::bincode::Decode, ::netabase_store::__macro_deps::__private::serde::Serialize, ::netabase_store::__macro_deps::__private::serde::Deserialize)]
        pub enum #key_name {
            #(#keys),*
        }
    };
