...
impl<'a> SchemaEnumGenerator<'a> {
    ...
    pub fn generate_schemas_enum(&self, enum_ident: &Ident) -> ItemEnum {
        ...
        parse_quote! {
            #[derive(NetabaseSchema, Debug, Clone, Encode, Decode)]
    ...
    pub fn generate_schema_keys_enum_from_attr(attr: &Attribute, enum_name: &Ident) -> ItemEnum {
        ...
        parse_quote! {
            #[derive(NetabaseSchemaKey, Debug, Clone, Encode, Decode)]
            pub enum #enum_name {
                #(#arms),*
            }
        }
...
impl<'a> SchemaEnumGenerator<'a> {
    fn generate_empty_enum(&self, enum_ident: &Ident, comment: &str) -> ItemEnum {
        parse_quote! {
