...
[features]
default = ["native", "redb"]
native = ["netabase/native", "netabase_store/native"]
...
**Native (Desktop/Server)** - Required for most use cases:
- TCP and QUIC transports
- mDNS local peer discovery
- Kademlia DHT for distributed records
- Sled and Redb storage backends
